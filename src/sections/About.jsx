            ...
            <Wrapper>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-10 items-start">
                    ...
                    <div className="flex flex-col justify-center items-start gap-y-4">
                        ...
                        <p className="max-w-full lg:max-w-160 font-light leading-normal text-light-gray text-left  text-base xl:text-lg">
                        ...
                        {/* counter */}
                        <div className="w-full xl:gap-x-6 flex items-center justify-center">
                            {/* experience */}
                            <div className="relative flex-1 after:w-px after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                                ...
                                <p className="text-xs uppercase tracking-[1px] leading-[1.4] text-light-gray">Years of experience</p>
                            </div>
                            {/* project */}
                            <div className="relative flex-1 after:w-px after:h-full ">
                                ...
                                <p className="text-xs w-full uppercase tracking-[1px] leading-[1.4] text-light-gray">Finished projects</p>
                            </div>
                        </div>
                    </div>
