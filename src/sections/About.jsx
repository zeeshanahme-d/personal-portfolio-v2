...
const About = () => {
    ...
    return (
        <div id="about" className="pt-28 pb-20 text-center xl:text-left">
            <div className="container mx-auto ">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-10 gap-y-10 items-start">
                    ...
                    <div className="flex flex-col justify-center gap-y-4 mt-5">
                        ...
                        <p className="max-w-full md:max-w-160 font-light leading-normal text-white/60 text-center md:text-left text-base xl:text-lg">
                        ...
                        <div className="flex-1 xl:gap-x-6 hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 mb-8">
                            ...
                            <div className="relative flex-1 after:w-px after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                                ...
                                <p className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] text-white/60">Years of experience</p>
                            </div>
                            {/* project */}
                            <div className="relative flex-1 after:w-px after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                                <p className="text-2xl xl:text-4xl font-extrabold text-primary mb-2">
                                ...
                                <p className="text-xs w-full uppercase tracking-[1px] leading-[1.4] max-w-[100px] text-white/60">Finished projects</p>
                            </div>
                            ...
                            <div className="relative flex-1">
                                ...
                                <p className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[150px] text-white/60">Award winning Projects</p>
                            </div>
