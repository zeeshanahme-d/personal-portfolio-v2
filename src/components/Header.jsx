...
const NAV_SECTION_IDS = ['about', 'skills', 'experience', 'projects', 'contact'];
...
const Header = () => {
    ...
    return (
        <motion.header
            ...
            className={`${show === 'hide' ? '-translate-y-full' : 'translate-y-0'
                } fixed top-0 z-50 w-full transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]`}
        >
            <div className="container pt-3 md:pt-4">
                <div className="flex min-h-13 items-center justify-between gap-2 rounded-2xl border px-5 py-0 lg:py-5 transition-[background,border-color,box-shadow] duration-500 md:min-h-14 border-border bg-background/80 shadow-[0_12px_48px_-12px_rgba(0,0,0,0.4)] backdrop-blur-xl">
                            ...
                            {navData.map((link, index) => {
                                return (
                                    <motion.button
                                        ...
                                        className="nav-link-desktop relative rounded-full px-4 py-1.5 text-[0.8rem] font-medium tracking-tight lg:px-3 lg:text-sm transition-colors duration-300"
                                        style={{
                        ...
                        <div className="container flex max-h-[min(70vh,520px)] flex-col gap-0.5 overflow-y-auto px-3 py-4">
                            ...
                            <motion.button
                                ...
                                className={buttonClassNames({
                                    variant: 'solid',
                                    size: 'sm',
                                    className: 'mt-2 flex h-12 w-full cursor-pointer items-center justify-center gap-2 text-base font-semibold active:scale-[0.99]',
                                })}
                                onClick={handleResumeDownload}
                            >
